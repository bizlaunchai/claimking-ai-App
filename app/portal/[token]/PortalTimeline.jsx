...
const TABS = [
    ...
    { key: 'estimate_created',          label: 'Estimates',        types: ['estimate_created', 'estimate_sent', 'estimate_revised', 'estimate_signed', 'estimate_signature_replaced'] },
...
const EVENT_META = {
    ...
    estimate_signature_replaced:{ dot: '#0ea5e9', badge: 'Re-signed',        badgeBg: '#dbeafe',  badgeFg: '#1e40af' },
