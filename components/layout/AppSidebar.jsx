            ...
            >
                ...
                <nav className="sidebar-nav">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard" className={`nav-link ${pathname === '/dashboard' ? 'active' : ''}`} data-tooltip="Estimation">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard" className={`nav-link ${pathname === '/dashboard' ? 'active' : ''}`} data-tooltip="Google My Business">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/settings" className={`nav-link ${pathname === '/dashboard/settings' ? 'active' : ''}`} data-tooltip="API Settings">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/settings" className={`nav-link ${pathname === '/dashboard/settings' ? 'active' : ''}`} data-tooltip="Account Settings">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/settings" className={`nav-link ${pathname === '/dashboard/settings' ? 'active' : ''}`} data-tooltip="Team Management">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/payments" className={`nav-link ${pathname === '/dashboard/payments' ? 'active' : ''}`} data-tooltip="Billing">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
