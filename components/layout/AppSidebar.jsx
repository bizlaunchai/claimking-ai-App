            ...
            >
                ...
                <nav className="sidebar-nav">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/estimation" className={`nav-link ${pathname === '/dashboard/estimation' ? 'active' : ''}`} data-tooltip="Estimation">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/3d-mockup" className={`nav-link ${pathname === '/dashboard/3d-mockup' ? 'active' : ''}`} data-tooltip="3D Mockups">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/policy-analysis" className={`nav-link ${pathname === '/dashboard/policy-analysis' ? 'active' : ''}`} data-tooltip="Policy Analysis">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/document-generator" className={`nav-link ${pathname === '/dashboard/document-generator' ? 'active' : ''}`} data-tooltip="Document Generator">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/emails" className={`nav-link ${pathname === '/dashboard/emails' ? 'active' : ''}`} data-tooltip="Email Assistant">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/ai-call-center" className={`nav-link ${pathname === '/dashboard/ai-call-center' ? 'active' : ''}`} data-tooltip="Call Center AI">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/storm-tracking" className={`nav-link ${pathname === '/dashboard/storm-tracking' ? 'active' : ''}`} data-tooltip="Storm Tracking">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/crm-sync" className={`nav-link ${pathname === '/dashboard/crm-sync' ? 'active' : ''}`} data-tooltip="CRM Sync">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/email-sms" className={`nav-link ${pathname === '/dashboard/email-sms' ? 'active' : ''}`} data-tooltip="Email & SMS">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/google-my-business" className={`nav-link ${pathname === '/dashboard/google-my-business' ? 'active' : ''}`} data-tooltip="Google My Business">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/social-media" className={`nav-link ${pathname === '/dashboard/social-media' ? 'active' : ''}`} data-tooltip="Social Media">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/api-settings" className={`nav-link ${pathname === '/dashboard/api-settings' ? 'active' : ''}`} data-tooltip="API Settings">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/analytics" className={`nav-link ${pathname === '/dashboard/analytics' ? 'active' : ''}`} data-tooltip="Analytics">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                                        <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/>
                                    </svg>
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/payments" className={`nav-link ${pathname === '/dashboard/payments' ? 'active' : ''}`} data-tooltip="Payments">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/settings" className={`nav-link ${pathname === '/dashboard/settings' ? 'active' : ''}`} data-tooltip="General Settings">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                                        <path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58a.49.49 0 0 0 .12-.61l-1.92-3.32a.488.488 0 0 0-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54a.484.484 0 0 0-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58a.49.49 0 0 0-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z"/>
                                    </svg>
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/account" className={`nav-link ${pathname === '/dashboard/account' ? 'active' : ''}`} data-tooltip="Account Settings">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/team" className={`nav-link ${pathname === '/dashboard/team' ? 'active' : ''}`} data-tooltip="Team Management">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/billing" className={`nav-link ${pathname === '/dashboard/billing' ? 'active' : ''}`} data-tooltip="Billing">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/referral" className={`nav-link ${pathname === '/dashboard/referral' ? 'active' : ''}`} data-tooltip="Referral Program">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
