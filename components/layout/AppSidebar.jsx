...
function Sidebar({isCollapsed, setIsCollapsed, isMobileOpen = false, closeMobile = () => {}}) {
    ...
    const handleMouseMove = useCallback((e) => {
        if (!isResizing || !sidebarRef.current || !resizeHandleRef.current || isMobile) return;
        ...
        <>
            ...
            >
                ...
                <div style={{borderBottom: '1px solid var(--border-color)'}} className='pb-2'>
                    {/* Header */}
                       <div className={`sidebar-header ${isCollapsed && !isMobile ? 'flex-col items-center justify-center mb-8 gap-3' : 'flex-row'}`}>
                           <Link href="/">
                ...
                <nav className="sidebar-nav">
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard" className={`nav-link ${pathname === '/dashboard' ? 'active' : ''}`} onClick={handleNavClick} data-tooltip="Overview">
                    ...
                    <div className="nav-category">
                        ...
                        {has('view_schedule') && (<div className="nav-item">
                            <Link href="/dashboard/schedule" className={`nav-link ${pathname.startsWith('/dashboard/schedule') ? 'active' : ''}`} onClick={handleNavClick} data-tooltip="Scheduling">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        {has('view_schedule') && (<div className="nav-item">
                            <Link href="/dashboard/packages" className={`nav-link ${pathname.startsWith('/dashboard/packages') ? 'active' : ''}`} onClick={handleNavClick} data-tooltip="Packages & Memberships">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        {has('manage_subs') && (<div className="nav-item">
                            <Link href="/dashboard/subs" className={`nav-link ${pathname.startsWith('/dashboard/subs') ? 'active' : ''}`} onClick={handleNavClick} data-tooltip="Subcontractors">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <span className="nav-text">Subcontractors</span>
                            </Link>
                        </div>)}
                    ...
                    <div className="nav-category">
                        ...
                        <div className="nav-item">
                            <Link href="/dashboard/referral" className={`nav-link ${pathname === '/dashboard/referral' ? 'active' : ''}`} onClick={handleNavClick} data-tooltip="Referral Program">
                                <span className="nav-icon">
                                    <svg viewBox="0 0 24 24">
                    ...
                    {showAdminSection && (
                        <div className="nav-category">
                            ...
                            {canAccess('manage_companies') && (
                                <div className="nav-item">
                                    <Link href="/dashboard/admin/companies" className={`nav-link ${pathname.startsWith('/dashboard/admin/companies') ? 'active' : ''}`} onClick={handleNavClick} data-tooltip="All Companies">
                                        <span className="nav-icon">
                                            <svg viewBox="0 0 24 24">
