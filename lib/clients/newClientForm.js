...
// Aug-12: single source of truth is now `lib/data/usStates.json`, shared with
// Settings → Company & Profile. Kept as `[code, label]` pairs so every existing
// consumer (client form + client-portal) stays unchanged.
export const CLIENT_STATES = US_STATES.map((s) => [s.code, s.name]);
...
export const CLIENT_CLAIM_STATUSES = [
    ...
    ["5", "5. ITEL Sample Required"], ["6", "6. Reinspection Requested"],
